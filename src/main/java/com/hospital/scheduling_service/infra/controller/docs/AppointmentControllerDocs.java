package com.hospital.scheduling_service.infra.controller.docs;
...
public interface AppointmentControllerDocs {
        ...
        @ApiResponse(responseCode = "422", description = "Regra de negócio violada",
            content = @Content(
                ...
                examples = @ExampleObject(
                    ...
                    value = "{\n  \"timestamp\": \"2026-09-04T09:15:00Z\",\n  \"status\": 422,\n  \"error\": \"Unprocessable Entity\",\n  \"message\": \"Não é possível agendar uma consulta em um horário já ocupado\",\n  \"path\": \"/api/v1/appointments\"\n}"
                )
            )
        ),
    ...
    ResponseEntity<AppointmentResponseDTO> create(
        @org.springframework.web.bind.annotation.RequestBody @Valid AppointmentRequestDTO request
    );
